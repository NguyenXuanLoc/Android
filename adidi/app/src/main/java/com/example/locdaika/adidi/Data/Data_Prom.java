...
public class Data_Prom extends AppCompatActivity {
    ...
    public void add_prom() {
        ...
        MainPage_Activity.arr_prom.add(new Slider_model(R.drawable.prom_vesinh, vesinh, content_vs, "R.drawable.prom_vesinh"));
        MainPage_Activity.arr_prom.add(new Slider_model(R.drawable.prom_donhang, donhang, content_dh, "R.drawable.prom_donhang"));
        MainPage_Activity.arr_prom.add(new Slider_model(R.drawable.prom_giaohang, giaohang, content_gh, "R.drawable.prom_giaohang"));
    }
